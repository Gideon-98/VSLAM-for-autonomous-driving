...
from lib.visualization.video import play_trip, draw_matches_frame
...
class VisualOdometry():
    ...
    def _form_transf(R, t):
        ...
        Returns
        -------
        T (ndarray): The transformation matrix. In the shape of (4, 4)
        """
    ...
    def get_matches(self, i):
        ...
        # Comment out to not show matches
        # draw_matches_frame(self.images[i - 1], kp1, self.images[i], kp2, good_matches)
